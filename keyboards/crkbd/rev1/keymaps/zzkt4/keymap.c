...
[BASE] = LAYOUT_split_3x6_3(KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC, KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, LT(MOVE, KC_QUOTE), LT(KC_LSFT, KC_UP), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, LT(HYPM, KC_DOWN), MO(EMACS), SC_LAPO, MT(MOD_LGUI, KC_SPACE), MT(MOD_LGUI, KC_ENTER), SC_RAPC, TT(NUMERIC)),

[NUMERIC] = LAYOUT_split_3x6_3(KC_TILDE, KC_EXCLAIM, KC_AT, KC_HASH, KC_DOLLAR, KC_PERCENT, KC_CIRCUMFLEX, KC_AMPERSAND, KC_ASTERISK, KC_MINUS, KC_EQUAL, KC_BSPC, KC_0, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, LT(MOVE, KC_ENTER), LT(KC_LSFT, KC_LEFT), KC_GRAVE, KC_TRNS, KC_BSLS, KC_LEFT_CURLY_BRACE, KC_LBRC, KC_RBRC, KC_RIGHT_CURLY_BRACE, KC_COMMA, KC_DOT, KC_PIPE, LT(KC_LSFT, KC_RIGHT), TG(QMIK), SC_LAPO, KC_TRNS, KC_TRNS, SC_RAPC, KC_TRNS),
